<script>
    ...
    const Listahamburguesas = [
    {
        ...
        hamburguesa: "Combo 1",
        precio: 12000,
        imagen: "../imagenes/combo-1.jpg",
        descripcion: "Delicioso Perro TASTE, porción de papas o (Eggbowl + $1500)  y bebida de tu elección."
    },
    {
        id: ':2',
        hamburguesa: "Combo 2",
        precio: 15000,
        imagen: "../imagenes/combo-2.jpg",
        descripcion: "La que siempre nos acompaña, nuestra hamburguesa clásica acompañada de papas o (Eggbowl + $1500) y bebida."
    },
    {
        id: ':3',
        hamburguesa: "Combo 3",
        precio: 17000,
        imagen: "../imagenes/combo-3.jpg",
        descripcion: "Hamburguesa Extraqueso, acompañada de papas o (Eggbowl + $1500) y bebida de tu elección."
    },
    {
        id: ':4',
        hamburguesa: "Combo 4",
        precio: 17000,
        imagen: "../imagenes/combo-4.jpg",
        descripcion: "Hamburguesa Colonial, acompañada de papas o (Eggbowl + $1500) y bebida de tu elección."
    },
    {
        id: ':5',
        hamburguesa: "Combo 5",
        precio: 20000,
        imagen: "../imagenes/combo-5.jpg",
        descripcion: "Hamburguesa Angus, Bebida (gaseosa o hit), Porción de papas o (Eggbowl + $1500)."
    },
    {
        id: ':6',
        hamburguesa: "Combo 6",
        precio: 18000,
        imagen: "../imagenes/combo-6.jpg",
        descripcion: "Deliciosa Hamburguesa Doble, Acompañada de papas o (Eggbowl + $1500)  y bebida de tu elección"
    }
];
    ...
    onMount( function() {
        ...
        checks.addEventListener('click', (e)=> {
            ...
            if (e.target.dataset.espec == "codorniz" && check == false){
                precioP = 1500 + precioP;
                pedido.precio = 1500 + pedido.precio;
                check = true;
                pedido.acompañantes = "eggbowl"
            }else if(e.target.dataset.espec == "codorniz" && check == true){
                precioP = precioP - 1500;
                pedido.precio = pedido.precio - 1500;
                pedido.acompañantes = "";
                   check = false;
            }
